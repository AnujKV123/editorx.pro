        ...
        {/* <!-- component -->
            ...
            <section className="relative mx-auto">
                ...
                <div className="px-5 xl:px-12 py-4 flex w-full items-center">
                    ...
                    <li><a className="hover:text-gray-200" href="#">Docs</a></li>
                    <li><a className="hover:text-gray-200" href="#">Pricing</a></li>
                    ...
                    {/* <!-- Sign In / Register         --> */}
                    {isAuthenticated && <div onClick={toggleUser} className="flex items-center hover:text-gray-200 cursor-pointer" >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>}
                    {!isAuthenticated && <div className="flex items-center hover:text-gray-200 cursor-pointer" >
                        <ul><Link className="hover:text-gray-200" to="/register">SignUp</Link></ul>
                    </div>}
                    
                    </div>
                </div>
                <div className="navbar-burger self-center mr-12 xl:hidden cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
