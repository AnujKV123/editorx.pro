...
export default function TextEditor() {
  ...
  useEffect(() => {
    const s = io("https://real-time-text-editor-backed.onrender.com")
    setSocket(s)
  ...
  return <>
          <div style={{backgroundColor: "back"}} className="container" ref={wrapperRef}></div>
          <div className="lg:absolute lg:top-40 lg:right-20 lg:w-20">
            <div className="fixed">
              ...
              {/* <div className="m-2">
                <Button onClick={downloadAsPdf}> Pdf &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <FileDown className="mr-2 h-4 w-4" /></Button>
              </div>
              <div className="m-2">
                <Button onClick={downloadAsDocs}> Docs &nbsp;&nbsp;&nbsp; <FileDown className="mr-2 h-4 w-4" /></Button>
              </div> */}
            </div>
          </div>
          <div className="lg:absolute lg:top-40 lg:left-20 lg:w-28">
            <div className="fixed w-48">
                <p className="p-1 text-center rounded-sm bg-blue-500"> Edited By </p>
              <div className="m-2">
